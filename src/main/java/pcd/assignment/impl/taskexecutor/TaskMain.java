package pcd.assignment.impl.taskexecutor;
...
import pcd.assignment.impl.taskexecutor.analyzer.TaskExecutorsSourceAnalyzer;
...
public class TaskMain {
    ...
    public static void main(String[] args) throws OperationNotSupportedException {
        System.out.println("Task-Executor-based approach");
